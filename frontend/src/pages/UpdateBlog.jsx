...
const UpdateBlog = () => {
    ...
    const updateBlogHandler = async () => {
        ...
        try {
            setLoading(true)
            const res = await axios.put(`https://blog-yt-3.onrender.com/blog/${id}`, formData, {
                headers: {
    ...
    const togglePublishUnpublish = async (action) => {
        ...
        try {
            const res = await axios.patch(`https://blog-yt-3.onrender.com/blog/${id}`, {
                params: {
                    action
                },
                withCredentials: true
    ...
    const deleteBlog = async () => {
        try {
            const res = await axios.delete(`https://blog-yt-3.onrender.com/blog/delete/${id}`, { withCredentials: true })
            if (res.data.success) {
